...
class Vanues_Inquery extends StatefulWidget {
  final String postId;
  final String Email;
  const Vanues_Inquery({Key key, this.postId, this.Email}) : super(key: key);
  Vanues_InqueryState createState() => Vanues_InqueryState();
}



class Vanues_InqueryState extends State<Vanues_Inquery> {
