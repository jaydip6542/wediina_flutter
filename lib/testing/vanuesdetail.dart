...
class VenueList1 extends StatefulWidget {
  String postId;
  VenueList1({ Key key,}) : super(key: key);
  @override
  VenueListState createState() => new VenueListState();

}

class VenueListState extends State<VenueList1> {
  String postId;
  ...
  getCountries() async {
    var response = await http.get('https://api-wediina.herokuapp.com/venue_by_cat_id/5d8e843fe7f82b0017e5a4bf');
