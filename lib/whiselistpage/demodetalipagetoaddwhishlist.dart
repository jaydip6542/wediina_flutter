...
import 'package:wediina_bussniss/loginwitherrormsg/logintestingerror.dart';
...
import 'package:wediina_bussniss/whiselistpage/whiselistfirstpage.dart';
...
class DetailPagevendor extends StatefulWidget {
  final String postId;
...
class DetailPageState extends State<DetailPagevendor> {
  String id;
  int _currentIndex = 2;
  int page = 0;
                        ...
                        children: <Widget>[
                          Container(
                            ...
                            child: IconButton(
                              ...
                              onPressed: ()=> _navigateTowhishlist(context, post['_id']),
                            ),
                          ),
                          Container(
                            margin: EdgeInsets.only(top: 10.0),
...
//    mainAxisSpacing: 7.0,
  ...
  void _navigateTowhishlist(BuildContext context, String _id,) {
    if( id == null ){

      Navigator.of(context).push(
        MaterialPageRoute(
          builder: (context) => Logindemoerror( ),
        ),
      );
      ...
      Navigator.of(context).push(
        MaterialPageRoute(
          builder: (context) => whiselistpage(postId: _id, ),
        ),
      );
